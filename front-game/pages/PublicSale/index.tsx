...
import Minter from "../../components/Minter2/Minter";
...
const Home: NextPage = () => {
  ...
  // TODO: change this for mainnet value
              ...
              <Row className={styles.buttonGroup}>
                <>
                  ...
                  <Button
                    className={styles.button}
                    style={{
                      transform: number === 3 ? 'translate3d(10px, 2px, 0) scale(1.1)' : '',
                      backgroundPosition: number === 3 ? '-100% 0' : '',
                      color: number === 3 ? 'black' : ''
                    }}
                    onClick={() => setNumber(3)}
                    variant="dark"
                  >
                  ...
                  <Button
                    className={styles.button}
                    style={{
                      transform: number === 4 ? 'translate3d(10px, 2px, 0) scale(1.1)' : '',
                      backgroundPosition: number === 4 ? '-100% 0' : '',
                      color: number === 4 ? 'black' : ''
                    }}
                    onClick={() => setNumber(4)}
                    variant="dark"
                  >
                  ...
                  <Button
                    className={styles.button}
                    style={{
                      transform: number === 5 ? 'translate3d(10px, 2px, 0) scale(1.1)' : '',
                      backgroundPosition: number === 5 ? '-100% 0' : '',
                      color: number === 5 ? 'black' : ''
                    }}
                    onClick={() => setNumber(5)}
                    variant="dark"
                  >
